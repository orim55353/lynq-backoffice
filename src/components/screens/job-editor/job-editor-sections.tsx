  ...
  return (
    <Card className="space-y-6 rounded-[10px] border-border bg-card p-5 shadow-soft">
      <div>
        ...
        <Input
          id="title"
          defaultValue={isNew ? "" : "Senior Product Designer"}
          className="mt-2"
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div>
          ...
          <div className="relative mt-2">
            ...
            <Input id="minSalary" defaultValue="120,000" className="pl-10" />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative mt-2">
            <DollarSign className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
            <Input id="maxSalary" defaultValue="180,000" className="pl-10" />
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="relative mt-2">
          ...
          <Input id="workType" defaultValue="Full-time, Hybrid" className="pl-10" />
        </div>
      </div>
      ...
      <div>
        ...
        <Textarea
          id="hook"
          defaultValue="Shape the future of our product experience. Join a world-class design team building tools used by millions."
      ...
      <div>
        ...
        <Textarea
          id="description"
          defaultValue="We're looking for a Senior Product Designer to join our growing team..."

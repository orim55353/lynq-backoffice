...
import { CandidateDetailPanel } from "@/components/screens/candidate-detail-panel";
import { Candidate, CandidateStage } from "@/components/screens/candidates-data";
    ...
    <AnimatePresence initial={false}>
      {candidate ? (
        <motion.div
          ...
          animate="animate"
          exit="exit"
          className="fixed right-0 top-0 z-20 flex h-screen border-l border-border bg-card shadow-[-18px_0_40px_-28px_rgba(15,23,42,0.28)]"

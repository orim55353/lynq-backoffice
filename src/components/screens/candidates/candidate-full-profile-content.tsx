...
import { Candidate, getCandidateById } from "@/components/screens/candidates/candidates-data";
import {
  CandidateDetailViewModel,
  CandidatePrimaryColumn,
  CandidateProfileHeader,
  CandidateSecondaryColumn
} from "@/components/screens/candidates/detail/candidate-detail-sections";
...
function getCandidateDetailViewModel(candidates: Candidate[], id: number): CandidateDetailViewModel {
  const candidate = getCandidateById(candidates, id);
...
export function CandidateFullProfileContent({ id, candidates, compact = false }: CandidateFullProfileContentProps) {
  const data = useMemo(() => getCandidateDetailViewModel(candidates, id), [candidates, id]);
